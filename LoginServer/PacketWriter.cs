...
namespace TrickEmu
{
    class PacketWriter
    {
        public static void SelectServer(byte[] dec, Socket sock)
        {
            ...
            msg.WriteString(Program._GameIP);
            //msg.WriteHexString("00 00 00");
            //msg.WriteHexString("20 01");
            //msg.WriteHexString("27 16");
            msg.WriteHexString("00 00 16 27");
            sock.Send(msg.getPacketDecrypted());
        }
